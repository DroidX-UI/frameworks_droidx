...
/**
 * Base DroidX-UI System Server which handles the starting and states of various DroidX-UI
 ...
 */
public class DroidXSystemServer {
    private static final String TAG = "DroidXSystemServer";
    ...
    public static void startServices(Context context, SystemServiceManager ssm) {
        String[] externalServices = context.getResources().getStringArray(
                com.android.internal.R.array.config_externalDroidXServices);
